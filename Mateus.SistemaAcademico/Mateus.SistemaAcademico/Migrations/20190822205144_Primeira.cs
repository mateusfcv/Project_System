        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotaAvaliacoes = table.Column<float>(nullable: false),
                    NotaSubstitutivas = table.Column<float>(nullable: false),
                    NotaExameFinal = table.Column<float>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TipoDeAvaliacoes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TipoDeAvaliacoes_Alunos_AlunoId",
                        column: x => x.AlunoId,
                        principalTable: "Alunos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_TipoDeAvaliacoes_Disciplinas_DisciplinaId",
                        column: x => x.DisciplinaId,
                        principalTable: "Disciplinas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TipoDeAvaliacoes_AlunoId",
                table: "TipoDeAvaliacoes",
                column: "AlunoId");

            migrationBuilder.CreateIndex(
                name: "IX_TipoDeAvaliacoes_DisciplinaId",
                table: "TipoDeAvaliacoes",
                column: "DisciplinaId");
