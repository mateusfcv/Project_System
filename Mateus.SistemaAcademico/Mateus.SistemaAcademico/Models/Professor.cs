...
namespace Mateus.SistemaAcademico.Models
{
    public class Professor : Pessoa
    {
        ...
        public Professor(string nome, List<Telefone> telefone, List<Endereco> endereco, string cpf, int registroDoProfessor, Disciplina disciplinasMinistratadas, string titulacao)
